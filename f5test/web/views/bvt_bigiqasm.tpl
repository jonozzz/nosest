...
{% block title %}BIG-IQ CM ASM BVT Request{% endblock %}

{% block description %}
     <h2>BIG-IP: BIG-IQ CM ASM BVT Request</h2>
     <p>This is intended for external teams who need to validate BIG-IP user builds, TCs, against BIG-IQ latest RTM build, for the ASM module only. Note that <code>Project</code> and <code>Build</code> parameters are required. Click on the dotted links to edit values. Check out the console tab for any log messages.</p>
{% endblock %}
                ...
                <table id="options" class="table table-bordered table-striped" style="clear: both">
                    <tbody> 
                        <tr>         
                            ...
                            <td width="35%"><span class="muted">e.g. 11.6.0, corona-bugs</span></td>
                        </tr>
                        <tr>
                            <td>Build</td>
...
{% block js %}
    <script src="/media/app.bvt_bigiqasm.js"></script>
{% endblock %}
