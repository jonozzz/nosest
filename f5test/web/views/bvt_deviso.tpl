...
{% block options %}
                <table id="options" class="table table-bordered table-striped" style="clear: both">
                    <tbody> 
                        <tr>         
                            <td width="15%" rowspan="2">BIG-IQ Custom ISO</td>
                            <td width="5%">Base:</td>
                            <td width="45%"><a href="#" id="iso" data-bind="editable: inputs.iso" data-type="text" data-inputclass="input-xxlarge" data-placeholder="Required" data-emptytext="Click to enter path to your dev iso" data-original-title="Enter the path to the ISO file"></a></td>
                            <td width="35%"><span class="muted">e.g.: /build/bigiq/project/bigiq-mgmt-cm/daily/build7932.0/BIG-IQ-bigiq-mgmt-cm-4.6.0.0.0.7932.iso (default: current build)</span></td>
                        </tr>
                        <tr>         
                            <td>Hotfix:</td>
